...
cl = KRIS.LINE()
cl.login(token='EuY9Y7EBeBEoQtx73303.4HaFUBefOJqDtvewnAeJuW.gty1ThqojmOp44ameOvPESy6Ly7WEUF/G+N5i8rPQHw=')
#cl.login(qr=True)
cl.loginResult()
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by :❂Rs͜͡F➣\nAdd siapa tau jodoh\nhttp://line.me/ti/p/~rsf.22 ")
          print "Like"
        except:
          pass
      else:
